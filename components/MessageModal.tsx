...
export const MessageModal: React.FC<Props> = ({ isOpen, message, onClose, type = 'info' }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden animate-bounce-in" 
      ...
      >
        <div className="p-6 text-center">
          ...
          <p className="text-slate-500 text-sm leading-relaxed whitespace-pre-wrap">{message}</p>
        </div>
